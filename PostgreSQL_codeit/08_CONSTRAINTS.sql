...
INSERT INTO tbl_cons_foreign_key_order VALUES (100, '아이폰16', 99, 'test1'); -- 성공, test1 아이디 존재함
INSERT INTO tbl_cons_foreign_key_order VALUES (101, '갤럭시z 플립7', 102, 'test3'); -- 실패, 외래키 제약으로 실패, 참조 할 테이블 test3 없어서!
...
DELETE FROM tbl_cons_foreign_key_user WHERE user_no = 2;
...
-- ALTER SEQUENCE codeit.user_auto_increment_user_no_seq RESTART WITH 300;
