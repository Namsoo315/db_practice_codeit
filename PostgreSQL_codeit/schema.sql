...
CREATE DATABASE spring_data ENCODING = 'UTF-8';
...
INSERT INTO users (id, created_at, username, password, email, nickname)
VALUES
    (1, NOW() - INTERVAL '5 days', 'test01', '1234', 'test01@email.com', '스프링마스터'),
    (2, NOW() - INTERVAL '4 days', 'test02', '1234', 'test02@email.com', '야근하는개발자'),
    (3, NOW() - INTERVAL '3 days', 'test03', '1234', 'test03@email.com', '판교러'),
    (4, NOW() - INTERVAL '2 days', 'test04', '1234', 'test04@email.com', '코드장인'),
    (5, NOW() - INTERVAL '1 days', 'test05', '1234', 'test05@email.com', '디버깅요정');
...
INSERT INTO comments (id, created_at, updated_at, content, author_id, post_id) VALUES
  (1, NOW() - INTERVAL '5 days', NOW() - INTERVAL '5 days', 'REST API 글 잘 봤습니다.', 2, 1),
  (2, NOW() - INTERVAL '4 days', NOW() - INTERVAL '4 days', '도움이 많이 되었어요.', 3, 1),
  (3, NOW() - INTERVAL '3 days', NOW() - INTERVAL '3 days', '커피 얘기 공감합니다!', 1, 2),
  (4, NOW() - INTERVAL '3 days', NOW() - INTERVAL '3 days', '연관관계 매핑 설명이 유익하네요.', 5, 3),
  (5, NOW() - INTERVAL '2 days', NOW() - INTERVAL '2 days', 'Hibernate 부분도 정리 부탁드려요.', 4, 3),
  (6, NOW() - INTERVAL '1 days', NOW() - INTERVAL '1 days', '저도 북한산 다녀왔습니다.', 2, 4),
  (7, NOW() - INTERVAL '2 days', NOW() - INTERVAL '2 days', 'Security 설정 이해에 도움 됩니다.', 3, 5),
  (8, NOW() - INTERVAL '6 days', NOW() - INTERVAL '6 days', '국밥집 위치가 궁금하네요!', 4, 6),
  (9, NOW() - INTERVAL '7 days', NOW() - INTERVAL '7 days', 'Docker Compose 글도 보고 싶습니다.', 5, 7),
  (10, NOW() - INTERVAL '6 days', NOW() - INTERVAL '6 days', '실무 적용 예시 기대합니다.', 1, 7),
  (11, NOW() - INTERVAL '5 days', NOW() - INTERVAL '5 days', '가족 나들이 보기 좋네요.', 2, 8),
  (12, NOW() - INTERVAL '4 days', NOW() - INTERVAL '4 days', 'MySQL 인덱스 부분이 특히 좋았습니다.', 3, 9),
  (13, NOW() - INTERVAL '2 days', NOW() - INTERVAL '2 days', '영화 감상평 잘 읽었습니다.', 4, 10),
  (14, NOW() - INTERVAL '1 days', NOW() - INTERVAL '1 days', '저도 같은 영화 봤어요!', 5, 10),
  (15, NOW() - INTERVAL '2 days', NOW() - INTERVAL '2 days', '쿠버네티스 전략 비교가 유익합니다.', 1, 11),
  (16, NOW() - INTERVAL '1 days', NOW() - INTERVAL '1 days', '자전거 코스 정보 감사해요.', 2, 12),
  (17, NOW() - INTERVAL '3 days', NOW() - INTERVAL '3 days', 'Redis 캐시 활용법 도움됩니다.', 3, 13),
  (18, NOW() - INTERVAL '2 days', NOW() - INTERVAL '2 days', '강아지 사진도 있나요?', 4, 14),
  (19, NOW() - INTERVAL '1 days', NOW() - INTERVAL '1 days', 'Git Flow 설명이 명확합니다.', 5, 15),
  (20, NOW() - INTERVAL '1 days', NOW() - INTERVAL '1 days', 'Trunk Based도 써봤습니다.', 1, 15),
  (21, NOW() - INTERVAL '2 days', NOW() - INTERVAL '2 days', '책 추천도 해주세요!', 2, 16),
  (22, NOW() - INTERVAL '1 days', NOW() - INTERVAL '1 days', 'Batch 작업 성능 팁 감사합니다.', 3, 17),
  (23, NOW() - INTERVAL '1 days', NOW() - INTERVAL '1 days', 'DIY 프로젝트 멋지네요.', 4, 18),
  (24, NOW() - INTERVAL '1 days', NOW() - INTERVAL '1 days', 'S3 업로드 코드 예시 부탁드려요.', 5, 19),
  (25, NOW() - INTERVAL '1 days', NOW() - INTERVAL '1 days', '캠핑 분위기 전해지네요.', 1, 20),
  (26, NOW() - INTERVAL '1 days', NOW() - INTERVAL '1 days', 'Elasticsearch 적용해봐야겠어요.', 2, 21),
  (27, NOW() - INTERVAL '1 days', NOW() - INTERVAL '1 days', '조깅 루틴 대단하세요.', 3, 22),
  (28, NOW() - INTERVAL '1 days', NOW() - INTERVAL '1 days', 'Kafka 글 잘 읽었습니다.', 4, 23),
  (29, NOW() - INTERVAL '1 days', NOW() - INTERVAL '1 days', 'Spring MVC는 쉽지 않죠 ㅎㅎ', 5, 24),
  (30, NOW() - INTERVAL '1 days', NOW() - INTERVAL '1 days', '요리 글 보니 배고파지네요.', 1, 25);
